...
#define __PYX_HAVE__pymaxion__constraints__cable
#define __PYX_HAVE_API__pymaxion__constraints__cable
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
static const char *__pyx_f[] = {
  "pymaxion/constraints/cable.pyx",
  "stringsource",
  "pymaxion/constraints/cable.pxd",
};
...
struct __pyx_obj_8pymaxion_11constraints_5cable_Cable;
...
/* "pymaxion/constraints/cable.pxd":3
...
/* "pymaxion/constraints/cable.pyx":10
...
struct __pyx_vtabstruct_8pymaxion_11constraints_5cable_Cable {
  struct __pyx_vtabstruct_8pymaxion_11constraints_10constraint_Constraint __pyx_base;
};
static struct __pyx_vtabstruct_8pymaxion_11constraints_5cable_Cable *__pyx_vtabptr_8pymaxion_11constraints_5cable_Cable;
...
static void __pyx_f_8pymaxion_11constraints_5cable_5Cable_calculate(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self, __Pyx_memviewslice __pyx_v_arr); /* proto*/
...
/* Module declarations from 'pymaxion.constraints.cable' */
static PyTypeObject *__pyx_ptype_8pymaxion_11constraints_5cable_Cable = 0;
...
#define __Pyx_MODULE_NAME "pymaxion.constraints.cable"
extern int __pyx_module_is_main_pymaxion__constraints__cable;
int __pyx_module_is_main_pymaxion__constraints__cable = 0;

/* Implementation of 'pymaxion.constraints.cable' */
...
static const char __pyx_k_distance_to_particle[] = "distance_to_particle";
...
static const char __pyx_k_Incorrect_number_of_particles_fo[] = "Incorrect number of particles for Cable";
...
static PyObject *__pyx_n_s_distance_to_particle;
...
static int __pyx_pf_8pymaxion_11constraints_5cable_5Cable___cinit__(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self); /* proto */
static int __pyx_pf_8pymaxion_11constraints_5cable_5Cable_2__init__(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self, PyObject *__pyx_v_particles, double __pyx_v_E, double __pyx_v_A, double __pyx_v_rest_length, CYTHON_UNUSED PyObject *__pyx_v_p_index); /* proto */
static PyObject *__pyx_pf_8pymaxion_11constraints_5cable_5Cable_1E___get__(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_8pymaxion_11constraints_5cable_5Cable_1A___get__(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_8pymaxion_11constraints_5cable_5Cable_11rest_length___get__(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_8pymaxion_11constraints_5cable_5Cable_4__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_8pymaxion_11constraints_5cable_5Cable_6__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state); /* proto */
...
static PyObject *__pyx_tp_new_8pymaxion_11constraints_5cable_Cable(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* "pymaxion/constraints/cable.pyx":12
 * cdef class Cable(Constraint):
 * 
 *     def __cinit__(Cable self):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static int __pyx_pw_8pymaxion_11constraints_5cable_5Cable_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_8pymaxion_11constraints_5cable_5Cable_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_r;
  ...
  __pyx_r = __pyx_pf_8pymaxion_11constraints_5cable_5Cable___cinit__(((struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *)__pyx_v_self));
...
static int __pyx_pf_8pymaxion_11constraints_5cable_5Cable___cinit__(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self) {
  int __pyx_r;
  ...
  __Pyx_TraceCall("__cinit__", __pyx_f[0], 12, 0, __PYX_ERR(0, 12, __pyx_L1_error));

  /* "pymaxion/constraints/cable.pyx":13
 * 
 *     def __cinit__(Cable self):
 *         self.constraint_n_particles = 2             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_self->__pyx_base.constraint_n_particles = 2;
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("pymaxion.constraints.cable.Cable.__cinit__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
...
/* "pymaxion/constraints/cable.pyx":15
 *         self.constraint_n_particles = 2
 * 
 *     def __init__(Cable self, list particles,             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static int __pyx_pw_8pymaxion_11constraints_5cable_5Cable_3__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_8pymaxion_11constraints_5cable_5Cable_3__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_particles = 0;
  double __pyx_v_E;
  double __pyx_v_A;
  double __pyx_v_rest_length;
  CYTHON_UNUSED PyObject *__pyx_v_p_index = 0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  int __pyx_r;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_particles,&__pyx_n_s_E,&__pyx_n_s_A,&__pyx_n_s_rest_length,&__pyx_n_s_p_index,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_E)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("__init__", 0, 3, 5, 1); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_A)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__init__", 0, 3, 5, 2); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (kw_args > 0) {
          PyObject* value = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rest_length);
    ...
    __pyx_v_E = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_E == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_A = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_A == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_rest_length = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_rest_length == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    } else {
      __pyx_v_rest_length = ((double)0.0);
    }
    __pyx_v_p_index = ((PyObject*)values[4]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__init__", 0, 3, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 15, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pymaxion.constraints.cable.Cable.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_particles), (&PyList_Type), 1, "particles", 1))) __PYX_ERR(0, 15, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_p_index), (&PyList_Type), 1, "p_index", 1))) __PYX_ERR(0, 17, __pyx_L1_error)
  __pyx_r = __pyx_pf_8pymaxion_11constraints_5cable_5Cable_2__init__(((struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *)__pyx_v_self), __pyx_v_particles, __pyx_v_E, __pyx_v_A, __pyx_v_rest_length, __pyx_v_p_index);
...
static int __pyx_pf_8pymaxion_11constraints_5cable_5Cable_2__init__(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self, PyObject *__pyx_v_particles, double __pyx_v_E, double __pyx_v_A, double __pyx_v_rest_length, CYTHON_UNUSED PyObject *__pyx_v_p_index) {
  ...
  /* "pymaxion/constraints/cable.pyx":19
 *                  list p_index=[]):
 * 
 ...
 */
  ...
  if (unlikely(__pyx_t_2)) {
    ...
    /* "pymaxion/constraints/cable.pyx":20
 * 
 *         if len(particles) != self.constraint_n_particles:
 *             raise ValueError("Incorrect number of particles for Cable")             # <<<<<<<<<<<<<<
 *         super().__init__(particles)
 ...
 */
  ...
  /* "pymaxion/constraints/cable.pyx":21
 *         if len(particles) != self.constraint_n_particles:
 *             raise ValueError("Incorrect number of particles for Cable")
 *         super().__init__(particles)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_INCREF(((PyObject *)__pyx_ptype_8pymaxion_11constraints_5cable_Cable));
  __Pyx_GIVEREF(((PyObject *)__pyx_ptype_8pymaxion_11constraints_5cable_Cable));
  PyTuple_SET_ITEM(__pyx_t_4, 0, ((PyObject *)__pyx_ptype_8pymaxion_11constraints_5cable_Cable));
  ...
  /* "pymaxion/constraints/cable.pyx":23
 *         super().__init__(particles)
 * 
 *         self.E = E             # <<<<<<<<<<<<<<
 *         self.A = A
 ...
 */
  ...
  /* "pymaxion/constraints/cable.pyx":24
 * 
 *         self.E = E
 *         self.A = A             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pymaxion/constraints/cable.pyx":26
 *         self.A = A
 * 
 *         if rest_length == 0.0:             # <<<<<<<<<<<<<<
 ...
 *             p0 = self.particles[0]
 */
  __pyx_t_2 = ((__pyx_v_rest_length == 0.0) != 0);
  if (__pyx_t_2) {

    /* "pymaxion/constraints/cable.pyx":28
 *         if rest_length == 0.0:
 *             # set initial length to current length
 *             p0 = self.particles[0]             # <<<<<<<<<<<<<<
 *             p1 = self.particles[1]
 ...
 */
    ...
    __pyx_t_3 = PyList_GET_ITEM(__pyx_v_self->__pyx_base.particles, 0);
    __Pyx_INCREF(__pyx_t_3);
    __pyx_v_p0 = __pyx_t_3;
    __pyx_t_3 = 0;

    /* "pymaxion/constraints/cable.pyx":29
 *             # set initial length to current length
 *             p0 = self.particles[0]
 *             p1 = self.particles[1]             # <<<<<<<<<<<<<<
 *             self.rest_length = p0.distance_to_particle(p1)
 ...
 */
    ...
    __pyx_t_3 = PyList_GET_ITEM(__pyx_v_self->__pyx_base.particles, 1);
    __Pyx_INCREF(__pyx_t_3);
    __pyx_v_p1 = __pyx_t_3;
    __pyx_t_3 = 0;

    /* "pymaxion/constraints/cable.pyx":30
 *             p0 = self.particles[0]
 *             p1 = self.particles[1]
 *             self.rest_length = p0.distance_to_particle(p1)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_p0, __pyx_n_s_distance_to_particle); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 30, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_4))) {
      __pyx_t_5 = PyMethod_GET_SELF(__pyx_t_4);
    ...
    __pyx_t_3 = (__pyx_t_5) ? __Pyx_PyObject_Call2Args(__pyx_t_4, __pyx_t_5, __pyx_v_p1) : __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_v_p1);
    __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_v_self->rest_length = __pyx_t_6;
 ...
 */
  ...
  /* "pymaxion/constraints/cable.pyx":32
 *             self.rest_length = p0.distance_to_particle(p1)
 *         else:
 *             self.rest_length = rest_length             # <<<<<<<<<<<<<<
 * 
 ...
 */
  /*else*/ {
    __pyx_v_self->rest_length = __pyx_v_rest_length;
  }
  __pyx_L4:;

  /* "pymaxion/constraints/cable.pyx":34
 *             self.rest_length = rest_length
 * 
 *         self.move_vectors.push_back(Vector3d(0.0, 0.0, 0.0))             # <<<<<<<<<<<<<<
 *         self.move_vectors.push_back(Vector3d(0.0, 0.0, 0.0))
 ...
 */
  try {
    __pyx_t_7 = geometry::Vector3d(0.0, 0.0, 0.0);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 34, __pyx_L1_error)
  }
  try {
    __pyx_v_self->__pyx_base.move_vectors->push_back(__pyx_t_7);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 34, __pyx_L1_error)
  }

  /* "pymaxion/constraints/cable.pyx":35
 * 
 *         self.move_vectors.push_back(Vector3d(0.0, 0.0, 0.0))
 *         self.move_vectors.push_back(Vector3d(0.0, 0.0, 0.0))             # <<<<<<<<<<<<<<
 *         self.strength.push_back((2 * E * A) / self.rest_length)
 ...
 */
  ...
  /* "pymaxion/constraints/cable.pyx":36
 *         self.move_vectors.push_back(Vector3d(0.0, 0.0, 0.0))
 *         self.move_vectors.push_back(Vector3d(0.0, 0.0, 0.0))
 *         self.strength.push_back((2 * E * A) / self.rest_length)             # <<<<<<<<<<<<<<
 *         self.strength.push_back((2 * E * A) / self.rest_length)
 ...
 */
  try {
    __pyx_v_self->__pyx_base.strength->push_back((((2.0 * __pyx_v_E) * __pyx_v_A) / __pyx_v_self->rest_length));
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 36, __pyx_L1_error)
  }

  /* "pymaxion/constraints/cable.pyx":37
 *         self.move_vectors.push_back(Vector3d(0.0, 0.0, 0.0))
 *         self.strength.push_back((2 * E * A) / self.rest_length)
 *         self.strength.push_back((2 * E * A) / self.rest_length)             # <<<<<<<<<<<<<<
 * 
...
/* "pymaxion/constraints/cable.pyx":39
 *         self.strength.push_back((2 * E * A) / self.rest_length)
 * 
 *     cdef void calculate(Cable self, double[:, :] arr) nogil:             # <<<<<<<<<<<<<<
...
static void __pyx_f_8pymaxion_11constraints_5cable_5Cable_calculate(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self, __Pyx_memviewslice __pyx_v_arr) {
  geometry::Vector3d __pyx_v_start_pt;
  geometry::Vector3d __pyx_v_end_pt;
  double __pyx_v_current_length;
  double __pyx_v_length_diff;
  geometry::Vector3d __pyx_v_force_start;
  geometry::Vector3d __pyx_v_force_end;
  geometry::Vector3d __pyx_v_force_dir;
  int __pyx_v_p1;
  int __pyx_v_p2;
  __Pyx_TraceDeclarations
  ...
  int __pyx_t_10;
  __Pyx_FakeReference<geometry::Vector3d> __pyx_t_11;
  __Pyx_FakeReference<geometry::Vector3d> __pyx_t_12;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_TraceCall("calculate", __pyx_f[0], 39, 1, __PYX_ERR(0, 39, __pyx_L1_error));

  /* "pymaxion/constraints/cable.pyx":48
 ...
 */
  try {
    __pyx_t_1 = (__pyx_v_self->__pyx_base.particle_index[0]).at(0);
  } catch(...) {
    #ifdef WITH_THREAD
  ...
  /* "pymaxion/constraints/cable.pyx":49
 * 
 *         p1 = self.particle_index[0].at(0)
 *         p2 = self.particle_index[0].at(1)             # <<<<<<<<<<<<<<
 *         start_pt = Vector3d(arr[p1, 0], arr[p1, 1], arr[p1, 2])
 ...
 */
  try {
    __pyx_t_2 = (__pyx_v_self->__pyx_base.particle_index[0]).at(1);
  } catch(...) {
    #ifdef WITH_THREAD
    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
    #endif
  ...
  /* "pymaxion/constraints/cable.pyx":50
 *         p1 = self.particle_index[0].at(0)
 *         p2 = self.particle_index[0].at(1)
 *         start_pt = Vector3d(arr[p1, 0], arr[p1, 1], arr[p1, 2])             # <<<<<<<<<<<<<<
 *         end_pt = Vector3d(arr[p2, 0], arr[p2, 1], arr[p2, 2])
 ...
 */
  ...
  __pyx_t_8 = 2;
  try {
    __pyx_t_9 = geometry::Vector3d((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_3 * __pyx_v_arr.strides[0]) ) + __pyx_t_4 * __pyx_v_arr.strides[1]) ))), (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_5 * __pyx_v_arr.strides[0]) ) + __pyx_t_6 * __pyx_v_arr.strides[1]) ))), (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_7 * __pyx_v_arr.strides[0]) ) + __pyx_t_8 * __pyx_v_arr.strides[1]) ))));
  } catch(...) {
    #ifdef WITH_THREAD
    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
    #endif
  ...
  __pyx_v_start_pt = __pyx_t_9;

  /* "pymaxion/constraints/cable.pyx":51
 *         p2 = self.particle_index[0].at(1)
 *         start_pt = Vector3d(arr[p1, 0], arr[p1, 1], arr[p1, 2])
 *         end_pt = Vector3d(arr[p2, 0], arr[p2, 1], arr[p2, 2])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_7 = 0;
  __pyx_t_6 = __pyx_v_p2;
  __pyx_t_5 = 1;
  __pyx_t_4 = __pyx_v_p2;
  __pyx_t_3 = 2;
  try {
    __pyx_t_9 = geometry::Vector3d((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_8 * __pyx_v_arr.strides[0]) ) + __pyx_t_7 * __pyx_v_arr.strides[1]) ))), (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_6 * __pyx_v_arr.strides[0]) ) + __pyx_t_5 * __pyx_v_arr.strides[1]) ))), (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_4 * __pyx_v_arr.strides[0]) ) + __pyx_t_3 * __pyx_v_arr.strides[1]) ))));
  } catch(...) {
    #ifdef WITH_THREAD
    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
    #endif
  ...
  __pyx_v_end_pt = __pyx_t_9;

  /* "pymaxion/constraints/cable.pyx":53
 *         end_pt = Vector3d(arr[p2, 0], arr[p2, 1], arr[p2, 2])
 * 
 *         force_dir = end_pt.vector_subtract(start_pt)             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_force_dir = __pyx_v_end_pt.vector_subtract(__pyx_v_start_pt);

  /* "pymaxion/constraints/cable.pyx":54
 * 
 *         force_dir = end_pt.vector_subtract(start_pt)
 *         current_length = force_dir.length()             # <<<<<<<<<<<<<<
 *         force_dir.vector_unitize()
 ...
 */
  __pyx_v_current_length = __pyx_v_force_dir.length();

  /* "pymaxion/constraints/cable.pyx":55
 *         force_dir = end_pt.vector_subtract(start_pt)
 *         current_length = force_dir.length()
 *         force_dir.vector_unitize()             # <<<<<<<<<<<<<<
 *         length_diff = current_length - self.rest_length
 *         if length_diff > 0.0:
 */
  __pyx_v_force_dir.vector_unitize();

  /* "pymaxion/constraints/cable.pyx":56
 *         current_length = force_dir.length()
 *         force_dir.vector_unitize()
 *         length_diff = current_length - self.rest_length             # <<<<<<<<<<<<<<
 *         if length_diff > 0.0:
 ...
 */
  __pyx_v_length_diff = (__pyx_v_current_length - __pyx_v_self->rest_length);

  /* "pymaxion/constraints/cable.pyx":57
 *         force_dir.vector_unitize()
 *         length_diff = current_length - self.rest_length
 *         if length_diff > 0.0:             # <<<<<<<<<<<<<<
 *             force_start = force_dir.vector_scale(0.5 * length_diff)
 ...
 */
  __pyx_t_10 = ((__pyx_v_length_diff > 0.0) != 0);
  if (__pyx_t_10) {

    /* "pymaxion/constraints/cable.pyx":58
 *         length_diff = current_length - self.rest_length
 *         if length_diff > 0.0:
 *             force_start = force_dir.vector_scale(0.5 * length_diff)             # <<<<<<<<<<<<<<
 *             force_end = force_dir.vector_scale(-0.5 * length_diff)
 *         else:
 */
    __pyx_v_force_start = __pyx_v_force_dir.vector_scale((0.5 * __pyx_v_length_diff));

    /* "pymaxion/constraints/cable.pyx":59
 *         if length_diff > 0.0:
 *             force_start = force_dir.vector_scale(0.5 * length_diff)
 *             force_end = force_dir.vector_scale(-0.5 * length_diff)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    __pyx_v_force_end = __pyx_v_force_dir.vector_scale((-0.5 * __pyx_v_length_diff));
 ...
 */
  ...
  /* "pymaxion/constraints/cable.pyx":61
 *             force_end = force_dir.vector_scale(-0.5 * length_diff)
 *         else:
 *             force_start = Vector3d(0, 0, 0)             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    try {
      __pyx_t_9 = geometry::Vector3d(0.0, 0.0, 0.0);
    } catch(...) {
      #ifdef WITH_THREAD
      PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
      #endif
    ...
    __pyx_v_force_start = __pyx_t_9;

    /* "pymaxion/constraints/cable.pyx":62
 *         else:
 *             force_start = Vector3d(0, 0, 0)
 *             force_end = Vector3d(0, 0, 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_v_force_end = __pyx_t_9;
  }
  __pyx_L3:;

  /* "pymaxion/constraints/cable.pyx":64
 *             force_end = Vector3d(0, 0, 0)
 * 
 *         self.move_vectors[0].at(0).set_value(force_start)             # <<<<<<<<<<<<<<
 ...
 */
  try {
    __pyx_t_11 = (__pyx_v_self->__pyx_base.move_vectors[0]).at(0);
  } catch(...) {
    #ifdef WITH_THREAD
    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
    #endif
  ...
  __pyx_t_11->set_value(__pyx_v_force_start);

  /* "pymaxion/constraints/cable.pyx":65
 * 
 *         self.move_vectors[0].at(0).set_value(force_start)
 *         self.move_vectors[0].at(1).set_value(force_end)             # <<<<<<<<<<<<<<
 * 
 */
  try {
    __pyx_t_12 = (__pyx_v_self->__pyx_base.move_vectors[0]).at(1);
  } catch(...) {
    #ifdef WITH_THREAD
    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
    #endif
  ...
  __pyx_t_12->set_value(__pyx_v_force_end);
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("pymaxion.constraints.cable.Cable.calculate", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
  __Pyx_TraceReturn(Py_None, 1);
}

/* "pymaxion/constraints/cable.pxd":4
 * 
 * cdef class Cable(Constraint):
 *     cdef readonly double E             # <<<<<<<<<<<<<<
 *     cdef readonly double A
...
/* Python wrapper */
static PyObject *__pyx_pw_8pymaxion_11constraints_5cable_5Cable_1E_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_8pymaxion_11constraints_5cable_5Cable_1E_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_8pymaxion_11constraints_5cable_5Cable_1E___get__(((struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *)__pyx_v_self));
...
static PyObject *__pyx_pf_8pymaxion_11constraints_5cable_5Cable_1E___get__(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self) {
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_self->E); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 4, __pyx_L1_error)
  ...
  __Pyx_AddTraceback("pymaxion.constraints.cable.Cable.E.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
/* "pymaxion/constraints/cable.pxd":5
 * cdef class Cable(Constraint):
 *     cdef readonly double E
 *     cdef readonly double A             # <<<<<<<<<<<<<<
 *     cdef readonly double rest_length
...
/* Python wrapper */
static PyObject *__pyx_pw_8pymaxion_11constraints_5cable_5Cable_1A_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_8pymaxion_11constraints_5cable_5Cable_1A_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_8pymaxion_11constraints_5cable_5Cable_1A___get__(((struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *)__pyx_v_self));
...
static PyObject *__pyx_pf_8pymaxion_11constraints_5cable_5Cable_1A___get__(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pymaxion.constraints.cable.Cable.A.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_TraceReturn(__pyx_r, 0);
...
/* "pymaxion/constraints/cable.pxd":6
 *     cdef readonly double E
 *     cdef readonly double A
 *     cdef readonly double rest_length             # <<<<<<<<<<<<<<
 */
...
/* Python wrapper */
static PyObject *__pyx_pw_8pymaxion_11constraints_5cable_5Cable_11rest_length_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_8pymaxion_11constraints_5cable_5Cable_11rest_length_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_8pymaxion_11constraints_5cable_5Cable_11rest_length___get__(((struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *)__pyx_v_self));
...
static PyObject *__pyx_pf_8pymaxion_11constraints_5cable_5Cable_11rest_length___get__(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_self->rest_length); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pymaxion.constraints.cable.Cable.rest_length.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_TraceReturn(__pyx_r, 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_8pymaxion_11constraints_5cable_5Cable_5__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_8pymaxion_11constraints_5cable_5Cable_5__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_8pymaxion_11constraints_5cable_5Cable_4__reduce_cython__(((struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *)__pyx_v_self));
...
static PyObject *__pyx_pf_8pymaxion_11constraints_5cable_5Cable_4__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pymaxion.constraints.cable.Cable.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_TraceReturn(__pyx_r, 0);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_8pymaxion_11constraints_5cable_5Cable_7__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static PyObject *__pyx_pw_8pymaxion_11constraints_5cable_5Cable_7__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_8pymaxion_11constraints_5cable_5Cable_6__setstate_cython__(((struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static PyObject *__pyx_pf_8pymaxion_11constraints_5cable_5Cable_6__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pymaxion.constraints.cable.Cable.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_TraceReturn(__pyx_r, 0);
  __Pyx_RefNannyFinishContext();
...
static struct __pyx_vtabstruct_8pymaxion_11constraints_5cable_Cable __pyx_vtable_8pymaxion_11constraints_5cable_Cable;

static PyObject *__pyx_tp_new_8pymaxion_11constraints_5cable_Cable(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *p;
  PyObject *o = __pyx_ptype_8pymaxion_11constraints_10constraint_Constraint->tp_new(t, a, k);
  if (unlikely(!o)) return 0;
  p = ((struct __pyx_obj_8pymaxion_11constraints_5cable_Cable *)o);
  p->__pyx_base.__pyx_vtab = (struct __pyx_vtabstruct_8pymaxion_11constraints_10constraint_Constraint*)__pyx_vtabptr_8pymaxion_11constraints_5cable_Cable;
  if (unlikely(__pyx_pw_8pymaxion_11constraints_5cable_5Cable_1__cinit__(o, __pyx_empty_tuple, NULL) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static void __pyx_tp_dealloc_8pymaxion_11constraints_5cable_Cable(PyObject *o) {
  ...
  PyObject_GC_Track(o);
  if (likely(__pyx_ptype_8pymaxion_11constraints_10constraint_Constraint)) __pyx_ptype_8pymaxion_11constraints_10constraint_Constraint->tp_dealloc(o); else __Pyx_call_next_tp_dealloc(o, __pyx_tp_dealloc_8pymaxion_11constraints_5cable_Cable);
}

static int __pyx_tp_traverse_8pymaxion_11constraints_5cable_Cable(PyObject *o, visitproc v, void *a) {
  int e;
  e = ((likely(__pyx_ptype_8pymaxion_11constraints_10constraint_Constraint)) ? ((__pyx_ptype_8pymaxion_11constraints_10constraint_Constraint->tp_traverse) ? __pyx_ptype_8pymaxion_11constraints_10constraint_Constraint->tp_traverse(o, v, a) : 0) : __Pyx_call_next_tp_traverse(o, v, a, __pyx_tp_traverse_8pymaxion_11constraints_5cable_Cable)); if (e) return e;
  return 0;
}

static int __pyx_tp_clear_8pymaxion_11constraints_5cable_Cable(PyObject *o) {
  if (likely(__pyx_ptype_8pymaxion_11constraints_10constraint_Constraint)) { if (__pyx_ptype_8pymaxion_11constraints_10constraint_Constraint->tp_clear) __pyx_ptype_8pymaxion_11constraints_10constraint_Constraint->tp_clear(o); } else __Pyx_call_next_tp_clear(o, __pyx_tp_clear_8pymaxion_11constraints_5cable_Cable);
  return 0;
}

static PyObject *__pyx_getprop_8pymaxion_11constraints_5cable_5Cable_E(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_8pymaxion_11constraints_5cable_5Cable_1E_1__get__(o);
}

static PyObject *__pyx_getprop_8pymaxion_11constraints_5cable_5Cable_A(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_8pymaxion_11constraints_5cable_5Cable_1A_1__get__(o);
}

static PyObject *__pyx_getprop_8pymaxion_11constraints_5cable_5Cable_rest_length(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_8pymaxion_11constraints_5cable_5Cable_11rest_length_1__get__(o);
}

static PyMethodDef __pyx_methods_8pymaxion_11constraints_5cable_Cable[] = {
  {"__reduce_cython__", (PyCFunction)__pyx_pw_8pymaxion_11constraints_5cable_5Cable_5__reduce_cython__, METH_NOARGS, 0},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_8pymaxion_11constraints_5cable_5Cable_7__setstate_cython__, METH_O, 0},
  {0, 0, 0, 0}
};

static struct PyGetSetDef __pyx_getsets_8pymaxion_11constraints_5cable_Cable[] = {
  {(char *)"E", __pyx_getprop_8pymaxion_11constraints_5cable_5Cable_E, 0, (char *)0, 0},
  {(char *)"A", __pyx_getprop_8pymaxion_11constraints_5cable_5Cable_A, 0, (char *)0, 0},
  {(char *)"rest_length", __pyx_getprop_8pymaxion_11constraints_5cable_5Cable_rest_length, 0, (char *)0, 0},
  {0, 0, 0, 0, 0}
};

static PyTypeObject __pyx_type_8pymaxion_11constraints_5cable_Cable = {
  PyVarObject_HEAD_INIT(0, 0)
  "pymaxion.constraints.cable.Cable", /*tp_name*/
  sizeof(struct __pyx_obj_8pymaxion_11constraints_5cable_Cable), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_8pymaxion_11constraints_5cable_Cable, /*tp_dealloc*/
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_8pymaxion_11constraints_5cable_Cable, /*tp_traverse*/
  __pyx_tp_clear_8pymaxion_11constraints_5cable_Cable, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_8pymaxion_11constraints_5cable_Cable, /*tp_methods*/
  0, /*tp_members*/
  __pyx_getsets_8pymaxion_11constraints_5cable_Cable, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  0, /*tp_descr_get*/
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  __pyx_pw_8pymaxion_11constraints_5cable_5Cable_3__init__, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_8pymaxion_11constraints_5cable_Cable, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static PyTypeObject __pyx_type___pyx_array = {
  PyVarObject_HEAD_INIT(0, 0)
  "pymaxion.constraints.cable.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pymaxion.constraints.cable.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pymaxion.constraints.cable.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pymaxion.constraints.cable._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_cable(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cable},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_distance_to_particle, __pyx_k_distance_to_particle, sizeof(__pyx_k_distance_to_particle), 0, 0, 1, 1},
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  __pyx_vtabptr_8pymaxion_11constraints_5cable_Cable = &__pyx_vtable_8pymaxion_11constraints_5cable_Cable;
  __pyx_vtable_8pymaxion_11constraints_5cable_Cable.__pyx_base = *__pyx_vtabptr_8pymaxion_11constraints_10constraint_Constraint;
  __pyx_vtable_8pymaxion_11constraints_5cable_Cable.__pyx_base.calculate = (void (*)(struct __pyx_obj_8pymaxion_11constraints_10constraint_Constraint *, __Pyx_memviewslice))__pyx_f_8pymaxion_11constraints_5cable_5Cable_calculate;
  __pyx_type_8pymaxion_11constraints_5cable_Cable.tp_base = __pyx_ptype_8pymaxion_11constraints_10constraint_Constraint;
  if (PyType_Ready(&__pyx_type_8pymaxion_11constraints_5cable_Cable) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
  __pyx_type_8pymaxion_11constraints_5cable_Cable.tp_print = 0;
  #endif
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_type_8pymaxion_11constraints_5cable_Cable.tp_dictoffset && __pyx_type_8pymaxion_11constraints_5cable_Cable.tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_type_8pymaxion_11constraints_5cable_Cable.tp_getattro = __Pyx_PyObject_GenericGetAttr;
  }
  if (__Pyx_SetVtable(__pyx_type_8pymaxion_11constraints_5cable_Cable.tp_dict, __pyx_vtabptr_8pymaxion_11constraints_5cable_Cable) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_Cable, (PyObject *)&__pyx_type_8pymaxion_11constraints_5cable_Cable) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_8pymaxion_11constraints_5cable_Cable) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_ptype_8pymaxion_11constraints_5cable_Cable = &__pyx_type_8pymaxion_11constraints_5cable_Cable;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcable(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcable(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cable(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cable(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cable(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  __Pyx_TraceDeclarations
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cable' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cable(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cable", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pymaxion__constraints__cable) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pymaxion.constraints.cable")) {
      if (unlikely(PyDict_SetItemString(modules, "pymaxion.constraints.cable", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  #endif
  __Pyx_TraceCall("__Pyx_PyMODINIT_FUNC PyInit_cable(void)", __pyx_f[0], 1, 0, __PYX_ERR(0, 1, __pyx_L1_error));

  /* "pymaxion/constraints/cable.pyx":17
 *     def __init__(Cable self, list particles,
 *                  double E, double A, double rest_length=0.0,
 *                  list p_index=[]):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pymaxion/constraints/cable.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pymaxion.constraints.cable", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pymaxion.constraints.cable");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
